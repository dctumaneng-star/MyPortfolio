      ...
      <div className="max-w-6xl mx-auto px-6 h-12 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span
            ...
            style={{ fontSize: "0.6rem", letterSpacing: "0.2em", color: "#707070", textTransform: "lowercase" }}
          >
            available
          </span>
        </div>
        ...
        <span
          ...
          style={{ fontSize: "0.6rem", letterSpacing: "0.12em", textTransform: "lowercase" }}
        >
          daryl tumaneng, 2026
        </span>
        ...
        <nav className="flex items-center gap-5">
          {[
            ...
            <a
              ...
              style={{ fontSize: "0.6rem", letterSpacing: "0.2em", textTransform: "lowercase",
